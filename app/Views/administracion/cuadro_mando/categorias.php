...
<main id="main">
    ...
    <div class="container">
        ...
        <div class="row">
            <form action="/administracion/cuadro_mando/categoria_filtrado" method="POST" role="form" enctype="multipart/form-data">
        ...
        <table class="table table-hover" data-aos="fade-up">
            <thead>
                <tr>
                    ...
                    <th>Codigo</th>
                    <th>Nombre</th>
                    <th>Ventas Esperadas por MES</th>
            ...
            <tbody>
                <?php foreach ($categoria as $key => $m): ?>
                    <tr>
                        <td>
                            <a class="btn" href="/administracion/cuadro_subcategoria/<?= $m->id ?>" style= "background-color: <?php if($m->promedio>80){
                                            echo '#4CAF50';                                                                      
            ...
            <?= $pagers->links('categoria','paginacion') ?>  
        </div>
