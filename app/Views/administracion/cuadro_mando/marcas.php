...
<main id="main">
    ...
    <div class="container">
        <div class="row">
                <form action="/administracion/cuadro_mando/marca_filtrado" method="POST" role="form" enctype="multipart/form-data">
        ...
        <table class="table table-hover" data-aos="fade-up">
            ...
            <tbody>
                <?php foreach ($marca as $key => $m): ?>
                    <tr>
                        <td>
                            <a class="btn" href="/administracion/cuadro_item/<?= $m->id ?>" style= "background-color: <?php if($m->promedio>80){
                                            echo '#4CAF50';                                                                      
