        ...
        <?php foreach ($detalle_comprobante as $key => $m): ?>
            <tr>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#comprobante_modal" data-bs-id="editar_detalle/<?= $m->id_detalle?>" >Editar</button>                 
                </td>
            </tr>
        <?php endforeach?>
        <tr>
            <td><form action="/administracion/save_comprobante/<?= $comprobante->id ?>" method="POST">
                <!-- Button trigger modal -->
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#comprobante_modal" data-bs-id="nuevo_detalle" >Agregar</button>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="confirmForm" action="" method="POST" enctype="multipart/form-data">      
            <div class="mb-3 row">
                <div class="col-sm-10">
                    <input type="checkbox" name="myCheckbox" id="debeCB" value="debe" onClick="toggleSelect(this)"/><span>Debe</span>
                    <input type="checkbox" name="myCheckbox" id="haberCB" value="haber" onClick="toggleSelect(this)"/><span>Haber</span>
                </div>
            </div>
...
<script>
    ...
    modalTitle.textContent = 'Detalle de Comprobante '+recipient
