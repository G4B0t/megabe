      ...
      <nav id="navbar" class="navbar ">
        <ul>
          <?php $i = 0; foreach($rol as $key =>$m):  $i++; ?>
                  ...
                  <?php  if(($m->nombre == "Vendedor" || $m->nombre == "Cajero" || $m->nombre =="Administrador") && $i<2){ ?>
                        <!-- MENU CAJERO o VENDEDOR --> 
                        <li><a class="nav-link scrollto" href="/administracion/ver_pedidos">Confirmar Pagos</a></li>
                  <?php } ?>
                    
                  <?php if($m->nombre == "Cajero" || $m->nombre =="Administrador"){ ?>
                    <!-- MENU CAJERO --> 
                  ...
                  <?php if($m->nombre == "Vendedor" || $m->nombre =="Administrador"){ ?>
                    <!-- MENU VENDEDOR --> 
                    <li><a class="nav-link scrollto" href="/administracion/armar_pedido"><span>Armar Pedido</span></a></li>
                  <?php } ?>
                    
                  <?php if($m->nombre == "Almacenes" || $m->nombre =="Administrador"){ ?>
                    <!-- MENU ALMACENERO --> 
