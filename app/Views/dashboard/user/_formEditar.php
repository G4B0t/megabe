    ...
    <div class="container">
         <div class="mb-3 row">
            <div class="col-lg-6 col-md-8">
                    ...
                    <div class="pic"><img src="<?= base_url()?>/imagen/clientes/<?= $cliente->foto?>" class="img-fluid" alt="" width="300" height="300"></div>
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="text" id="usuario" name="usuario" value="<?=old('usuario', $cliente->usuario)?>"/><br />
            </div>
        </div>
        <div class="mb-3 row">
            <label for="email" class="col-sm-2 col-form-label">Email:</label>
            <div class="col-sm-10">
                <input class="form-control" type="text" id="email" name="email"  value="<?=old('email', $cliente->email)?>" /><br />
            </div>
        </div>
        <div class="mb-3 row">
